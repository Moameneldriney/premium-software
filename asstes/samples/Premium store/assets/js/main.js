...
function changeLang(lang) {
	...
	if(lang == 'ar'){
			...
			document.getElementById('lnagLink').setAttribute('href', 'assets/css/style2.css');
	}
}
...
(function ($) {
	...
	var categoryToggle2 = $('.category-toggle2');
	var categoryMenu2 = $('.category-menu2');
	var categoryToggle3 = $('.category-toggle3');
	var categoryMenu3 = $('.category-menu3');
	var categoryToggle4 = $('.category-toggle4');
	var categoryMenu4 = $('.category-menu4');
	...
	categoryToggle2.on('click', function () {
		categoryMenu2.slideToggle();
	});
	categoryToggle3.on('click', function () {
		categoryMenu3.slideToggle();
	});
	categoryToggle4.on('click', function () {
		categoryMenu4.slideToggle();
	});
	// Category Sub Menu
	...
	amount.val( rangeSlider.slider("values", 1));
